...
<table border="1" style="text-align: left;">
	<tbody>
        ...
        <tr>
            ...
            <td colspan="1">Landing Page Optimizada</td>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="5">
                ...
                <strong>Entonces</strong> estos deben enviarse automáticamente al sistema de cocina.<br><br>
        ...
        <tr>
            ...
            <td colspan="1">Registro de Merma</td>
            <td colspan="1">Como administrador, quiero registrar y monitorear las mermas de ingredientes para ajustar las compras futuras y reducir pérdidas.</td>
            <td colspan="5">
                <strong>Escenario 01:</strong> Registrar y Monitorear Merma<br>
                <strong>Dado que</strong> se produce una merma en los ingredientes,<br>
                <strong>Cuando</strong> registre la merma en el sistema,<br>
                <strong>Entonces</strong> el sistema debe permitir el registro de la cantidad perdida y generar un reporte semanal que muestre las mermas acumuladas.<br><br>
                <strong>Escenario 02:</strong> Analizar Datos de Merma<br>
                <strong>Dado que</strong> he registrado las mermas en el sistema,<br>
                <strong>Cuando</strong> acceda al reporte semanal,<br>
                <strong>Entonces</strong> podré analizar los datos de merma y ajustar las órdenes de compra en consecuencia.
            </td>
            <td colspan="1">No Corresponde</td>
        </tr>
        <tr>
...
<tr>
    ...
    <td colspan="1">Gestión de Proveedores</td>
    <td colspan="1">Como administrador, quiero gestionar proveedores y sus productos para poder hacer órdenes de compra fácilmente.</td>
    <td colspan="5">
        <strong>Escenario 01:</strong> Agregar Proveedores<br>
        <strong>Dado que</strong> soy administrador,<br>
        <strong>Cuando</strong> quiera registrar un nuevo proveedor,<br>
        <strong>Entonces</strong> el sistema debe permitir agregar sus datos, productos y precios en una base de proveedores.<br><br>
        <strong>Escenario 02:</strong> Actualizar Información de Proveedores<br>
        <strong>Dado que</strong> el precio de un producto cambia,<br>
        <strong>Cuando</strong> reciba la nueva información del proveedor,<br>
        <strong>Entonces</strong> podré actualizar los precios o productos en el sistema sin complicaciones.
    </td>
    <td colspan="1">EP02</td>
</tr>
<tr>
    <td colspan="1">US-08</td>
    <td colspan="1">Ordenar Insumos a Proveedores</td>
    <td colspan="1">Como administrador, quiero realizar órdenes de compra a proveedores de manera rápida y eficiente para asegurar la disponibilidad de insumos.</td>
    <td colspan="5">
        <strong>Escenario 01:</strong> Crear Orden de Compra<br>
        <strong>Dado que</strong> necesito insumos,<br>
        <strong>Cuando</strong> el stock esté bajo,<br>
        <strong>Entonces</strong> podré generar una orden de compra automáticamente seleccionando los productos y el proveedor, y enviarla directamente desde el sistema.<br><br>
        <strong>Escenario 02:</strong> Confirmar Recepción de Insumos<br>
        <strong>Dado que</strong> he realizado una orden de compra,<br>
        <strong>Cuando</strong> reciba los insumos,<br>
        <strong>Entonces</strong> podré confirmar la recepción de los mismos en el sistema para actualizar el stock.
    </td>
    <td colspan="1">EP02</td>
</tr>
<tr>
    <td colspan="1">US-09</td>
    <td colspan="1">Creación de Menús</td>
    <td colspan="1">Como administrador, quiero crear menús personalizados con platos del sistema para ofrecer a los clientes una variedad adecuada.</td>
    <td colspan="5">
        <strong>Escenario 01:</strong> Crear Nuevo Menú<br>
        <strong>Dado que</strong> soy administrador,<br>
        <strong>Cuando</strong> quiera crear un nuevo menú,<br>
        <strong>Entonces</strong> podré seleccionar los platos disponibles y asignarles precios, y el menú estará disponible para los clientes.<br><br>
        <strong>Escenario 02:</strong> Modificar Menú Existente<br>
        <strong>Dado que</strong> ya existe un menú,<br>
        <strong>Cuando</strong> quiera cambiar algún plato o precio,<br>
        <strong>Entonces</strong> podré modificar el menú existente sin afectar el funcionamiento del sistema.
    </td>
    <td colspan="1">EP03</td>
</tr>
<tr>
    <td colspan="1">US-10</td>
    <td colspan="1">Calificación de Clientes</td>
    <td colspan="1">Como administrador, quiero permitir a los clientes calificar su experiencia para mejorar el servicio en el restaurante.</td>
    <td colspan="5">
        <strong>Escenario 01:</strong> Registrar Calificaciones<br>
        <strong>Dado que</strong> soy cliente,<br>
        <strong>Cuando</strong> termine mi comida,<br>
        <strong>Entonces</strong> podré calificar mi experiencia directamente en el sistema o a través de una aplicación móvil.<br><br>
        <strong>Escenario 02:</strong> Ver Calificaciones Acumuladas<br>
        <strong>Dado que</strong> soy administrador,<br>
        <strong>Cuando</strong> consulte las calificaciones del restaurante,<br>
        <strong>Entonces</strong> podré ver un reporte detallado de las calificaciones y comentarios acumulados.
    </td>
    <td colspan="1">EP04</td>
</tr>
<tr>
    <td colspan="1">US-11</td>
    <td colspan="1">Informe de Ventas</td>
    <td colspan="1">Como administrador, quiero generar informes de ventas diarios y mensuales para evaluar el rendimiento del restaurante.</td>
    <td colspan="5">
        <strong>Escenario 01:</strong> Generar Informe Diario<br>
        <strong>Dado que</strong> necesito conocer las ventas del día,<br>
        <strong>Cuando</strong> el día termine,<br>
        <strong>Entonces</strong> podré generar un informe detallado que incluya el total de ventas, platos más vendidos y otros datos relevantes.<br><br>
        <strong>Escenario 02:</strong> Generar Informe Mensual<br>
        <strong>Dado que</strong> necesito evaluar el rendimiento mensual,<br>
        <strong>Cuando</strong> el mes termine,<br>
        <strong>Entonces</strong> podré generar un informe que muestre las ventas acumuladas del mes, junto con estadísticas clave como ingresos y productos más populares.
    </td>
    <td colspan="1">EP05</td>
</tr>
<tr>
    <td colspan="1">US-12</td>
    <td colspan="1">Historial de Órdenes</td>
    <td colspan="1">Como administrador, quiero ver un historial de órdenes de clientes para identificar patrones y preferencias.</td>
    <td colspan="5">
        <strong>Escenario 01:</strong> Ver Historial de Órdenes<br>
        <strong>Dado que</strong> soy administrador,<br>
        <strong>Cuando</strong> acceda al historial de órdenes,<br>
        <strong>Entonces</strong> podré ver un registro detallado de todas las órdenes realizadas por cada cliente.<br><br>
        <strong>Escenario 02:</strong> Filtrar Historial por Cliente<br>
        <strong>Dado que</strong> quiero conocer el historial de un cliente específico,<br>
        <strong>Cuando</strong> seleccione su nombre en el sistema,<br>
        <strong>Entonces</strong> podré ver todas sus órdenes previas y analizar sus preferencias.
    </td>
    <td colspan="1">EP06</td>
</tr>
<tr>
    <td colspan="1">US-13</td>
    <td colspan="1">Integración con Aplicaciones de Delivery</td>
    <td colspan="1">Como administrador, quiero integrar el sistema con aplicaciones de delivery para aumentar las ventas del restaurante.</td>
    <td colspan="5">
        <strong>Escenario 01:</strong> Sincronizar Pedidos de Delivery<br>
        <strong>Dado que</strong> soy administrador,<br>
        <strong>Cuando</strong> un pedido se realice a través de una aplicación de delivery,<br>
        <strong>Entonces</strong> este debe sincronizarse automáticamente con el sistema del restaurante.<br><br>
        <strong>Escenario 02:</strong> Actualizar Estado de Pedido<br>
        <strong>Dado que</strong> un pedido está en proceso,<br>
        <strong>Cuando</strong> el estado cambie,<br>
        <strong>Entonces</strong> el sistema debe actualizar automáticamente el estado en la aplicación de delivery.
    </td>
    <td colspan="1">EP07</td>
</tr>
<tr>
    <td colspan="1">US-14</td>
    <td colspan="1">Notificaciones Automáticas a Clientes</td>
    <td colspan="1">Como administrador, quiero enviar notificaciones automáticas a los clientes para informarles sobre promociones y descuentos.</td>
    <td colspan="5">
        <strong>Escenario 01:</strong> Enviar Notificaciones por Promociones<br>
        <strong>Dado que</strong> hay una promoción disponible,<br>
        <strong>Cuando</strong> esta promoción esté activa,<br>
        <strong>Entonces</strong> el sistema debe enviar automáticamente notificaciones a los clientes registrados.<br><br>
        <strong>Escenario 02:</strong> Configurar Horarios de Envío<br>
        <strong>Dado que</strong> quiero evitar enviar notificaciones en horarios inadecuados,<br>
        <strong>Cuando</strong> programe una campaña de notificación,<br>
        <strong>Entonces</strong> podré configurar un rango de horarios para su envío.
    </td>
    <td colspan="1">EP08</td>
</tr>
<tr>
    <td colspan="1">US-15</td>
    <td colspan="1">Administración de Empleados</td>
    <td colspan="1">Como administrador, quiero gestionar la información y horarios de empleados para asegurar la correcta operación del restaurante.</td>
    <td colspan="5">
        <strong>Escenario 01:</strong> Registrar Empleados<br>
        <strong>Dado que</strong> soy administrador,<br>
        <strong>Cuando</strong> quiera registrar un nuevo empleado,<br>
        <strong>Entonces</strong> el sistema debe permitir agregar sus datos personales, cargo y horario.<br><br>
        <strong>Escenario 02:</strong> Asignar y Modificar Horarios<br>
        <strong>Dado que</strong> debo asignar horarios a los empleados,<br>
        <strong>Cuando</strong> registre o modifique un horario,<br>
        <strong>Entonces</strong> el sistema debe actualizar la información y permitir notificar al empleado de cualquier cambio.
    </td>
...
|----------------|---------|-----------|------------------------------|---------------------------------------------------------|---------------------|
| regrill-test   | main    | a1b2c3    | feat: create feature test 10 | - Validate order creation<br>- Test for invalid data    | 23/11/2024         |
| regrill-test   | main    | d4e5f6    | feat: create feature test 11 | - Verify item addition to order<br>- Check stock validation | 23/11/2024         |
| regrill-test   | main    | g7h8i9    | feat: create feature test 12 | - Implement order cancellation test<br>- Validate refund | 23/11/2024         |
| regrill-test   | main    | j0k1l2    | feat: create feature test 13 | - Test user authentication<br>- Verify token expiry cases | 23/11/2024         |
| regrill-test   | main    | m3n4o5    | feat: create feature test 14 | - Test order summary generation<br>- Validate item details | 23/11/2024         |
| regrill-test   | main    | p6q7r8    | fix: update tests for feature 10 | - Fix missing error messages<br>- Add new validation rules | 23/11/2024         |
| regrill-test   | main    | s9t0u1    | fix: update tests for feature 11 | - Improve edge case handling<br>- Enhance test coverage  | 23/11/2024         |
| regrill-test   | main    | v2w3x4    | feat: add feature test 15    | - Test order shipment tracking<br>- Validate notifications | 23/11/2024         |
| regrill-test   | main    | y5z6a7    | fix: update i18n tests       | - Add locale-specific messages<br>- Verify language toggle | 23/11/2024         |
| regrill-test   | main    | b8c9d0    | fix: resolve bug in order summary | - Correct calculation issues<br>- Add edge case tests   | 23/11/2024         |


### 5.2.4.5 Execution Evidence for Sprint Review.

Actualmente, hemos realizado modificaciones en el frontend, ya que no cumplimos con todos los requisitos funcionales en el sprint anterior.   
La aplicación es accesible a través del siguiente enlace: https://webfront-regrill-deploy-5emm.vercel.app/login

<img src="resources/execution-evidence/1.png"/>

<img src="resources/execution-evidence/2.png"/>

En la página de aterrizaje se incorporaron los videos "about the product" y "about the team", con el objetivo de dar a conocer de manera más efectiva nuestro producto a través de un video promocional y de presentar a nuestro equipo  
Link de acceso al Landing Page: https://webfront-regrill-deploy.vercel.app/landing

<img src="resources/execution-evidence/3.png"/>
...
<table>
  ...
  <tr>
   <th style="text-align:center;"> <strong> SupplierOrder </strong> </th>
    <th> <strong> /api/v1/suoolierorder </strong> </th>
    <th> <img src="resources/endpoints/1.png"> </th>
  </tr>


  <tr>
   <th> <strong> Recipe </strong> </th>
    <th> <strong> /api/v1/recipe </strong> </th>
    <th> <img src="resources/endpoints/2.png"> </th>
  </tr>

  <tr>
   <th> <strong> Orders </strong> </th>
    <th> <strong> /api/v1/orders </strong> </th>
    <th> <img src="resources/endpoints/3.png"> </th>
  </tr>

<tr>
   <th style="text-align:center;"> <strong> Invoices </strong> </th>
    <th> <strong> /api/v1/invoices </strong> </th>
    <th> <img src="resources/endpoints/4.png"> </th>
  </tr>


  <tr>
   <th> <strong> AdminStock </strong> </th>
    <th> <strong> /api/v1/adminstock </strong> </th>
    <th> <img src="resources/endpoints/5.png"> </th>
  </tr>

  <tr>
   <th> <strong> Authentication </strong> </th>
    <th> <strong> /api/v1/authentication </strong> </th>
    <th> <img src="resources/endpoints/6.png"> </th>
  </tr>

   <tr>
   <th> <strong> Role </strong> </th>
    <th> <strong> /api/v1/role </strong> </th>
    <th> <img src="resources/endpoints/7.png"> </th>
  </tr>

  <tr>
   <th> <strong> Users </strong> </th>
    <th> <strong> /api/v1/users </strong> </th>
    <th> <img src="resources/endpoints/8.png"> </th>
  </tr>
...
En este sprint, se ha desarrollado la API de la aplicación web, utilizando las siguientes herramientas. Asimismo, el despliegue de la API está incluido en el alcance de este sprint.
...
Link del Front-End: https://webfront-regrill-deploy-5emm.vercel.app/login

<img src="resources/deployment/1.jpeg">

<img src="resources/deployment/2.jpeg">

Link del Backend: https://regrill-api.onrender.com/swagger/index.html

<img src="resources/deployment/3.png">

<img src="resources/deployment/4.png">

### 5.2.4.8 Team Collaboration Insights during Sprint.

A continuación se mostrarán el gráfico de insights durante el sprint:

<img src="resources/colabsprint4/1.png">

<img src="resources/colabsprint4/2.png"/>

<img src="resources/colabsprint4/3.png"/>

<img src="resources/colabsprint4/4.png"/>

<img src="resources/colabsprint4/5.png"/>

<img src="resources/colabsprint4/6.png"/>

<img src="resources/colabsprint4/7.png"/>
